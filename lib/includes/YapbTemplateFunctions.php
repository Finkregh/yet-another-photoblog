<?php
	...
	function yapb_thumbnail($before, $parameters = array('alt' => ''), $after, $phpThumbConfiguration = array('w=200','q=90'), $cssClassname='') {
		echo yapb_get_thumbnail($before, $parameters, $after, $phpThumbConfiguration, $cssClassname);
	}
	 ...
	 */
	function yapb_get_alternative_image_formats($limits = array(1280, 1024, 800, 640, 320), $liClass='yapb_alternative_format') {
	 ...
	 */
	function yapb_alternative_image_formats($limits = array(1280, 1024, 800, 640, 320), $liClass='yapb_alternative_format') {
